        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Card className="p-4 border-2 border-transparent hover:border-accent/50 cursor-pointer transition-all">
              ...
              <Card className="p-4 border-2 border-accent cursor-pointer bg-accent/5">
