...
import { ArrowRight, Calendar, Flame, Target, Clock, CheckCircle2 } from "lucide-react"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 px-8 h-12" asChild>
              <Link href="/dashboard">
                Open dashboard
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            {[
              { value: "MVP", label: "Shipped features" },
              { value: "Local", label: "Your data stays in-browser" },
              { value: "7d", label: "Habit progress window" },
